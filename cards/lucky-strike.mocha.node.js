...
describe('./cards/lucky-strike.js', () => {
	it('can be instantiated with defaults', () => {
		...
		expect(luckyStrike.description).to.equal('A man in a jester\'s hat smiles at you from the crowd. You feel... Lucky for some reason. Or perhaps feel the unluckiness of your opponent...');
