...
See [`docs/roadmap/10-bug-fixes.md`](docs/roadmap/10-bug-fixes.md) for the open list (#3 content pass, plus audit follow-ups #63, #73, #78).

Previously listed here and now fixed: card shop process-wide singleton (#26), fight log stale after new fights (#15), console history missing on reconnect (#16/#17), Discord free-text prompts / serialization (#59/#60), workshop↔console same-user guard (#61), and the 2026-08-03 audit fixes (#51–#58, #74–#77: XP floor, Flee threshold, Pick Pocket crash, ring batch dupes, boss despawn timers, Discord auto-join, prompt sentinel, web room bleed, fight-outcome labelling, two flaky tests). See `docs/roadmap/10b-bugs-fixed.md`.
