...
| A | One vocabulary (`train`, `call out`, `dismiss`, `fallen`, `fight`, `Lvl n`, pronouns) + `docs/voice-and-wording.md` | Tier 3 doc, Tier 2 apply | ✅ `3864145`, `8896b6d`, `1372f8f`, `f244a3b`, `ae39f1a`; review found 4 Important (leaked `battle`/`encounter`/`arena`, `Owner`/`L3`, `in`-operator key check, never-working Discord `/spawn [type] [name]`), fixed in `e472c19`, `712b317`; #163 | `docs/voice-and-wording.md` |
