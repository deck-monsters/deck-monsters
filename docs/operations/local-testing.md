---
type: Runbook
title: Local testing guidelines (env-driven sessions)
description: Manual end-to-end checks, service startup, and reusable local test rooms.
status: stable
audience: internal
tags: [testing, local, rooms]
---
