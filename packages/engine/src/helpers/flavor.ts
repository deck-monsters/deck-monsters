...
type FlavorEntry = [string, number] | [string, number, string];
...
type FlavorCategory = 'hits' | 'monsterAdjective';

interface FlavorData {
	getFlavor(category: FlavorCategory, flavors?: Record<FlavorCategory, FlavorEntry[]>): FlavorResult;
	flavors: Record<FlavorCategory, FlavorEntry[]>;
}

export const flavor: FlavorData = {
	getFlavor(
		category: FlavorCategory,
		flavors: Record<FlavorCategory, FlavorEntry[]> = flavor.flavors
	): FlavorResult {
